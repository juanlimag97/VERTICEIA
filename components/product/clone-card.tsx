...
export function CloneCard({
  cloneUrl,
  platformTag = "Projeto incluído · Lovable",
  description = "A Vértice IA construiu e investiu neste projeto — e transfere uma cópia completa pra sua conta do Lovable. É isso que o remix faz: um clique, o Lovable duplica o projeto, e ele passa a ser 100% seu pra editar e publicar.",
  buttonLabel = "Receber o projeto no Lovable",
}: {
